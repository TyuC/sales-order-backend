...
export class SalesOrderHeaderModel {
    ...
    public validateCreationPayload(params: CreationPayload): CreationPayloadValidationResult {
        ...
        this.items.forEach(items => {
            const validationResult = items.validateCreationPayload({ product_id: items.productId });
    ...
    private validateCustomerOnCreation(customer_id: CreationPayload['customer_id']): CreationPayloadValidationResult {
        if (!customer_id) {
            return {
                hasError: true,
